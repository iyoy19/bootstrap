      ...
      <div className="flex flex-col flex-wrap max-w-5xl p-2.5 mx-auto md:flex-row">
        ...
        >
          <div className="flex flex-wrap items-center justify-center pt-1 pl-2 ml-1 space-x-8 md:space-x-16 md:mx-auto md:pl-14">
            ...
            <Link href="/404" a className="text-black transition duration-300 dark:text-gray-300 hover:text-gray-300">
                Topik
            </Link>
          </div>
          <button
            ...
            type="button"
            className="w-10 h-10 p-3 ml-5 mr-0 bg-gray-200 rounded-full md:ml-0 md:mr-5 dark:bg-gray-800"
